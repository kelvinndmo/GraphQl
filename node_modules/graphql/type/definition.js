...
var GraphQLScalarType =
  ...
  (function() {
    function GraphQLScalarType(config) {
      ...
      this.parseLiteral =
        config.parseLiteral || _valueFromASTUntyped.valueFromASTUntyped;
      this.astNode = config.astNode;
      this.extensionASTNodes = undefineIfEmpty(config.extensionASTNodes);
      !(typeof config.name === 'string')
        ? (0, _invariant.default)(0, 'Must provide name.')
        : void 0;
  ...
  return (0, _mapValue.default)(fieldMap, function(fieldConfig, fieldName) {
    ...
    !!fieldConfig.hasOwnProperty('isDeprecated')
      ? (0, _invariant.default)(
          ...
          ''
            .concat(config.name, '.')
            .concat(fieldName, ' should provide "deprecationReason" ') +
    ...
    !isPlainObj(argsConfig)
      ? (0, _invariant.default)(
          ...
          ''
            .concat(config.name, '.')
            .concat(fieldName, ' args must be an object with argument ') +
            'names as keys.'
        )
      : void 0;
  ...
  return (0, _objectEntries.default)(valueMap).map(function(_ref2) {
    ...
    !!value.hasOwnProperty('isDeprecated')
      ? (0, _invariant.default)(
          ...
          ''
            .concat(type.name, '.')
            .concat(valueName, ' should provide "deprecationReason" instead ') +
            'of "isDeprecated".'
        )
      : void 0;
    return {
  ...
  return (0, _mapValue.default)(fieldMap, function(fieldConfig, fieldName) {
    !!fieldConfig.hasOwnProperty('resolve')
      ? (0, _invariant.default)(
          ...
          ''
            .concat(config.name, '.')
            .concat(fieldName, ' field has a resolve property, but ') +
